...
export const AccountInputSchema = {
    ...
    updateMany: z.object({
        data: z.union([AccountUpdateManyMutationInputObjectSchema, AccountUncheckedUpdateManyInputObjectSchema]),
        where: AccountWhereInputObjectSchema.optional(),
    }),
    upsert: z.object({
        select: z.lazy(() => AccountSelectObjectSchema.optional()),
    ...
    count: z.object({
        ...
        skip: z.number().optional(),
        distinct: z.array(AccountScalarFieldEnumSchema).optional(),
        select: z.union([z.literal(true), AccountCountAggregateInputObjectSchema]).optional(),
    }),
