...
type SchemaType = z.ZodType<Prisma.LessonUncheckedUpdateManyWithoutSubjectNestedInput>;
export const LessonUncheckedUpdateManyWithoutSubjectNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
