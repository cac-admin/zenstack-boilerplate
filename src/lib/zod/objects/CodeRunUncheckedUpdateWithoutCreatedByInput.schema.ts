...
type SchemaType = z.ZodType<Prisma.CodeRunUncheckedUpdateWithoutCreatedByInput>;
export const CodeRunUncheckedUpdateWithoutCreatedByInputObjectSchema: SchemaType = z
    .object({
