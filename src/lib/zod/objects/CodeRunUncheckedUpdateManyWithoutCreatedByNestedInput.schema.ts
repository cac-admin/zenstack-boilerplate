...
type SchemaType = z.ZodType<Prisma.CodeRunUncheckedUpdateManyWithoutCreatedByNestedInput>;
export const CodeRunUncheckedUpdateManyWithoutCreatedByNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
