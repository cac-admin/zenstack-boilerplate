...
type SchemaType = z.ZodType<Prisma.LessonCreateNestedManyWithoutAuthorInput>;
export const LessonCreateNestedManyWithoutAuthorInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
