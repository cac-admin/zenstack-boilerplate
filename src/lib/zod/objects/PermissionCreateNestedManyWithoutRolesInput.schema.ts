...
type SchemaType = z.ZodType<Prisma.PermissionCreateNestedManyWithoutRolesInput>;
export const PermissionCreateNestedManyWithoutRolesInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
