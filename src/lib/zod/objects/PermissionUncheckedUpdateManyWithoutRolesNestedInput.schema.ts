...
type SchemaType = z.ZodType<Prisma.PermissionUncheckedUpdateManyWithoutRolesNestedInput>;
export const PermissionUncheckedUpdateManyWithoutRolesNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
