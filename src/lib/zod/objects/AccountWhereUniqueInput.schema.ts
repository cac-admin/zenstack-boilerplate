...
export const AccountWhereUniqueInputObjectSchema: SchemaType = z
    .object({
        ...
        provider_providerAccountId: z
            ...
            .optional(),
        AND: z
            .union([z.lazy(() => AccountWhereInputObjectSchema), z.lazy(() => AccountWhereInputObjectSchema).array()])
            .optional(),
        OR: z
        ...
        access_token: z
            ...
            .nullable(),
        expires_at: z
            .union([z.lazy(() => IntNullableFilterObjectSchema), z.number(), z.null()])
            .optional()
            .nullable(),
        token_type: z
            .union([z.lazy(() => StringNullableFilterObjectSchema), z.string(), z.null()])
