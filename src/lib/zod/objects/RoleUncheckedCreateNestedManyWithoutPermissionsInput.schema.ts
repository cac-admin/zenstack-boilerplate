...
type SchemaType = z.ZodType<Prisma.RoleUncheckedCreateNestedManyWithoutPermissionsInput>;
export const RoleUncheckedCreateNestedManyWithoutPermissionsInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
