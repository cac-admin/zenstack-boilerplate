...
type SchemaType = z.ZodType<Prisma.RoleUncheckedUpdateManyWithoutPermissionsNestedInput>;
export const RoleUncheckedUpdateManyWithoutPermissionsNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
