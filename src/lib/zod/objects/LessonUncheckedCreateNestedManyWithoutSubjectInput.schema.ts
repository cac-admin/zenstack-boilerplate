...
type SchemaType = z.ZodType<Prisma.LessonUncheckedCreateNestedManyWithoutSubjectInput>;
export const LessonUncheckedCreateNestedManyWithoutSubjectInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
