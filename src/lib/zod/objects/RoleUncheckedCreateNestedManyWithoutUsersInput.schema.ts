...
type SchemaType = z.ZodType<Prisma.RoleUncheckedCreateNestedManyWithoutUsersInput>;
export const RoleUncheckedCreateNestedManyWithoutUsersInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
