...
type SchemaType = z.ZodType<Prisma.LessonUncheckedUpdateManyWithoutAuthorNestedInput>;
export const LessonUncheckedUpdateManyWithoutAuthorNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
