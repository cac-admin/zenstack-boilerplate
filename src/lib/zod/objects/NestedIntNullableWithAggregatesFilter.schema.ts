...
export const NestedIntNullableWithAggregatesFilterObjectSchema: SchemaType = z
    .object({
        ...
        not: z
            .union([z.number(), z.lazy(() => NestedIntNullableWithAggregatesFilterObjectSchema), z.null()])
            .optional()
            .nullable(),
