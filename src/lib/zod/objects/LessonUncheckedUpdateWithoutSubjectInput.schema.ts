...
type SchemaType = z.ZodType<Prisma.LessonUncheckedUpdateWithoutSubjectInput>;
export const LessonUncheckedUpdateWithoutSubjectInputObjectSchema: SchemaType = z
    .object({
