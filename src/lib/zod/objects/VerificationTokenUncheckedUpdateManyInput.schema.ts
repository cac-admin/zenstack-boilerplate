...
type SchemaType = z.ZodType<Prisma.VerificationTokenUncheckedUpdateManyInput>;
export const VerificationTokenUncheckedUpdateManyInputObjectSchema: SchemaType = z
    .object({
